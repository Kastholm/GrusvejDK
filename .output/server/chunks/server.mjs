import { version, getCurrentInstance, inject, ref, watchEffect, watch, createApp, reactive, unref, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const layouts = {
  default: () => import('./default-24b23e03.mjs').then((m) => m.default || m)
};
...
const _routes = [
  {
    name: "Stabiliseringafvejen",
    path: "/Stabiliseringafvejen",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./Stabiliseringafvejen-5f288886.mjs').then((m) => m.default || m)
  },
  {
    name: "Stoevbekaempelse",
    path: "/Stoevbekaempelse",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./Stoevbekaempelse-289066c0.mjs').then((m) => m.default || m)
  },
  {
    name: "grusveje",
    path: "/grusveje",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./grusveje-d707f35b.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-dfb8c32e.mjs').then((m) => m.default || m)
  },
  {
    name: "kontakt",
    path: "/kontakt",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./kontakt-44fee9eb.mjs').then((m) => m.default || m)
  },
  {
    name: "loading",
    path: "/loading",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./loading-fcdb2290.mjs').then((m) => m.default || m)
  },
  {
    name: "maskineriet",
    path: "/maskineriet",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./maskineriet-9c523f4b.mjs').then((m) => m.default || m)
  },
  {
    name: "naturstier",
    path: "/naturstier",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./naturstier-b93c82dd.mjs').then((m) => m.default || m)
  },
  {
    name: "nyheder",
    path: "/nyheder",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./nyheder-c6c27c83.mjs').then((m) => m.default || m)
  },
  {
    name: "serviceaftale",
    path: "/serviceaftale",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./serviceaftale-08291278.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-97c0a1f0.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-126e8b3b.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
