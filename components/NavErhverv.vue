...
const navigation = [
  { name: "Forside", href: "/erhverv", current: true },
  { name: "Grusveje", href: "/grusveje-erhverv", current: false },
  { name: "Naturstier", href: "/naturstier", current: false },
  { name: "Støvbekæmpelse", href: "/stoevbekaempelse-erhverv", current: false },
  {
  ...
  { name: "Maskineri", href: "/maskineriet", current: false },
