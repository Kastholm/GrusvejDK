<template>
      ...
      <center>
        <div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
          <div class="sm:max-w-full">
            <!-- skal gøres til H1-->
            <h1
              class="relative lg:text-[67px] text-[1.8rem] fontfam-NO-W mb-10 text-center max-w-[80%] m-auto pb-6 pt-10"
            >
              Vedligeholdelsesaftaler <br />
              - en investering i vejens levetid og vores ressourcer
            </h1>
            <!-- skal gøres til H1-->
          </div>
        </div>
  ...
  <section class="bg-white dark:bg-gray-800 sm:text-start text-center">
    ...
    >
      <div
        class="flex max-w-[1200px] items-center justify-center lg:flex-row flex-col gap-10"
      >
        <div
        ...
        >
          <p class="text-white">
            ...
            ><br /><br />
            Vil du gerne have en pæn og velfungerende grusvej uden selv at
            skulle holde øje med det hele?<br />
            Med vores basis vedligeholdelsesaftale sørger vi for, at din grusvej
            bliver passet løbende – så små problemer ikke udvikler sig til store
            og dyre reparationer.
          </p>
          <ul class="w-full flex flex-col gap-4">
            <p>
              Aftalen kan nemt udvides efter behov, og du vælger helt frit til
              og fra. Det giver både fleksibilitet, overblik og en bedre pris.
              Du kan tilvælge – <strong>helt uden binding:</strong>
            </p>
            <li class="text-start font-bold">- Støvbekæmpelse</li>
            <li class="text-start font-bold">
              - Ekstra service efter skybrud og kraftig regn
            </li>
            <li class="text-start font-bold">
              - Forstærket vedligeholdelse ved tung trafik eller byggeri
            </li>
          </ul>
        </div>
        <div
          ...
          <div class="mt-8 space-y-8">
            <div class="flex items-start">
              <svg
                ...
                class="max-w-5 max-h-5 min-w-5 min-h-5 text-[#137733]"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
              ...
              <span class="sm:mx-4 text-gray-700 dark:text-gray-300"
                >Gælder for grusveje på 100–300 meter. Er der mere, får du
                rabat. Er der mindre, skal vi have et lille gebyr for at
                komme.</span
              >
            </div>
            <div class="flex items-start">
              ...
              <span class="sm:mx-4 text-gray-700 dark:text-gray-300"
                >Maks. <strong>3 meters bredde.</strong></span
              >
            </div>
            <div class="flex items-start">
              <svg
              ...
              <span class="sm:mx-4 text-gray-700 dark:text-gray-300"
                >Arealer over 300 meter gives <strong>20% rabat</strong></span
              >
            </div>

            <button
              @click="selectServiceOption('Basis')"
              class="w-full px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-[#137733] rounded-md hover:bg-[#f9b039] focus:outline-none focus:bg-blue-600"
            >
              Vælg
            </button>
          </div>
