    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 h-fit">
      ...
      <img
        ...
        <div class="translate-y-10 sm:-translate-x-0 gap-6 grid grid-rows-2 w-fit m-auto mb-16">  
          ...
          <a class="text-2xl sm:text-4xl border-b border-l-4 font-semibold border-t-2 fontfam shadow-[#f9b039] shadow-sm rounded p-4 border-[#f9b039] ml-6" href="tel:+45 29 29 01 29">
