<template>
  <head>
    ...
    <meta name="description" content="Grusvej.dk er eksperter i Jordstabilisering - et vigtigt punkt i processen, når en solid grusvej skal etableres og holde kvaliteten i flere år frem.">
  </head>
  <StabiliseringHero />
  <div
    class="relative isolate overflow-hidden px-6 py-10 sm:py-32 lg:overflow-visible lg:px-0 z-1"
  >
    <div
    ...
    >
      ...
      >
        <img
          class="z-20 w-[48rem] lg:max-w-none max-h-[42em] rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]"
          src="https://i.ibb.co/hdhN5pN/Stabilisering-grus-1.webp"
          alt=""
        />
      </div>
      <div
  ...
  <div class="w-full pt-10 relative -translate-y-36">
    <h2
