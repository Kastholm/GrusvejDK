  ...
  <div class="bg-white">
    <main class="isolate">
      ...
      <div class="-translate-y-16 m-auto text-center">
        <h3
          class="mt-2 text-5xl margin sm:w-[43%] font-bold tracking-wide text-gray-900 sm:text-6xl fontfam"
        >
          DE <span class="text-SubColor2 sm:text-8xl">5</span> BUD
          <br />
          <span class="sm:text-5xl">- PÅ EN PERFEKT GRUSVEJ</span>
        </h3>
      </div>
      ...
      <div class="tabBody -translate-y-20">
        ...
        <transition name="fade" mode="out-in">
          <div class="tab-content" :key="currentTab.id">
            <div class="px-2">
              <h2 class="font-bold -translate-y-4 sm:-translate-y-0">
                {{ currentTab.name }}
              </h2>
              <h3 class="translate-x-1 translate-y-2 font-bold">
                {{ currentTab.manchet }}
              </h3>
              <p class="translate-y-0 sm:translate-y-10">
                {{ currentTab.text }}
              </p>
              <p class="translate-y-0 sm:translate-y-16">
                {{ currentTab.text2 }}
              </p>
            </div>
            <div
      ...
      <div class="flex items-center justify-center">
        <div class="relative text-center">
          ...
          >
            ...
            unik for det perfekte resultat hver gang der skal lægges nye
            grusveje med grove baser af større sten og betonstumper.
          </p>
        </div>
      </div>

      <!-- Image section -->
      <div class="relative xl:mx-auto xl:max-w-7xl xl:px-8 mt-10">
        <img
...
const tabs = [
  {
    ...
    text2:
      "Slid på biler og dæk er også forbundet med vand, da vandet på ubehandlet veje vender småsten med den skarpe side op der resulterer i svær slid af bla. dæk på køretøjer.",
    manchet: "Bud 1",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    text2:
      "Det rette tempo på afledning af vandet er en vigtig faktor for, at vejen mister minimalt af grus og materiale over tid.",
    manchet: "Bud 4",
  },
  {
    id: 5,
    ...
    text2:
      "Det rette grus er vigtigt for vejens holdbarhed, at anvende den forkerte type grus kan resultere i, at vejens profil aftager langt hurtigere.",
    manchet: "Bud 5",
  },
];
