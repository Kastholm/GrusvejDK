    ...
    <main class="isolate">
      ...
      <div class="relative isolate -z-10">
        ...
        <div class="mx-auto max-w-2xl lg:mx-0 inline">
          ...
          >
            <span class="sm:text-9xl text-7xl rounded uppercase"> Dustex </span>- <span> ET </span><span class=" uppercase text-[#199d43]"> miljøvenligt </span> PRODUKT
          </h2>
...
<div class="mx-auto max-w-7xl px-6 sm:mt-0 lg:px-8 translate-y-10 sm:-translate-y-10 ">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
            <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
              <p class="text-xl leading-8 text-gray-700 font-bold">
                Et eksempel fra de danske grusveje:
              </p>
              <div class="mt-10 max-w-xl text-xl leading-7 text-gray-700">
                <p>
                  Grundejere i sommerhusområder er nogle af dem som er mest plaget af støvgener. På Tuse Næs i Nordvestsjælland valgte man for år tilbage derfor at tage fat i problemet. 
                  <br><br>”Det er nu tre år siden at Grusvej.dk renoverede vores fælles veje og gav dem den rigtige profil, så vejene kan holde. Når vi kan mærke, at støvgenerne begynder at komme igen, ringer vi bare til Grusvej.dk. Intervallerne afhænger altid af, hvordan vejret har opført sig”, fortælle kasserer i Fjordvang Grundejerforening, Kim Zengenberg, som er glad for samarbejdet med Grusvej.dk.

                </p>
                <p class="mt-10 text-xl">
                  ”Det har givet en markant forbedring at få lagt Dustex på de tilhørende fælles veje. Vores biler er ikke konstant støvet til, og vi slipper for støvskyer drivende mellem og ind i husene.” <br><br>
                  Hvor lang tid der skal gå mellem støvbehandlingerne, afhænger af hvor længe og hvor tørt vejret er. I perioder med ustadigt og fugtigt vejr er problemet med støv selvsagt ikke så stort, mens sommerens lange tørkeperioder fremmer problemet med støv fra grusvejene. 
            ...
            <div class="lg:flex lg:flex-auto lg:justify-center flex-rows-reverse sm:-translate-y-0 -translate-y-20">
              <dl class="w-64 space-y-8 xl:w-80 inline lg:block">
                <div
                  v-for="stat in stats"
                  :key="stat.label"
                  class="flex flex-col-reverse gap-y-4 border-4 border-[#f9b039] bg-[#f9b039] text-center rounded-lg p-1 font-semibold translate-y-20"
                >
                  <dt class="text-base leading-1 text-white -translate-y-2">
                    {{ stat.label }}
                  </dt>
                  <center>
                  <dd
                    class="text-4xl fontfam font-bold tracking-wide text-white"
                  >
                    {{ stat.value }}
                  </dd>
                  </center>
      ...
      <div class="relative w-full rounded-md pt-24">
        <div
          ref="playerContainer"
          id="vimeo-player"
          class="mt-10 aspect-[6/5] h-72 w-screen rounded-2xl sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 grid place-content-center overflow-hidden"
          style="height: 515px;"
        >
          <button
            @click="toggleVideo"
...
const stats = [
  ...
  { label: "Kroppen tager skade af kontinuerlig indånding af støvpartikler fra grusarealer. ", value: "Giver et bedre helbred" },
];
const values = [
  {
    name: "Ufarligt",
